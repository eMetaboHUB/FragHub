...
test_file = r'C:\Users\Axel\PycharmProjects\msp_v3\INPUT\MSP\ALL_GNPS.msp'


with open(test_file, "r", encoding="utf8") as buffer:
    content = buffer.read()
...
def msp_to_json_processing(spectrum_list):
    ...
    chunk_size = 5000
    final = []
    progress_bar = tqdm(total=len(spectrum_list), unit=" spectrums", colour="green", desc="{:>80}".format("converting spectrums"))
...
print(msp_to_json_processing(spectrum_list))