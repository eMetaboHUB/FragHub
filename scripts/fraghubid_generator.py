...
def generate_fraghub_id(FINAL_MSP, FINAL_XML, FINAL_CSV, FINAL_JSON, FINAL_MGF):
    ...
    :param FINAL_MSP: The path to the converted MSP file.
    :param FINAL_XML: The path to the converted XML file.
    :param FINAL_CSV: The path to the converted CSV file.
    :param FINAL_JSON: The path to the converted JSON file.
    :param FINAL_MGF: The path to the converted MGF file.
    :return: A tuple containing the FragHub IDs for each file type (FINAL_MSP, FINAL_XML, FINAL_CSV, FINAL_JSON, FINAL_MGF).
    """
    if FINAL_MSP:
