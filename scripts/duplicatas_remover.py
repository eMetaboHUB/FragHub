...
def remove_duplicatas_lrsv(POS_LC,POS_GC,NEG_LC,NEG_GC):
    ...
    if empty == False:
        ...
        POS_LC_df = pd.DataFrame.from_dict(dictionary)
        # Removing duplicatas
        POS_LC_df = POS_LC_df.sort_values('NUM PEAKS', ascending=False).drop_duplicates(['INCHIKEY', 'PRECURSORTYPE']).sort_index()
        # Re convert to MSP
        POS_LC = []
        for index,row in POS_LC_df.iterrows():
            SPECTRUM = ""
    ...
    if empty == False:
        ...
        POS_GC_df = pd.DataFrame.from_dict(dictionary)
        # Removing duplicatas
        POS_GC_df = POS_GC_df.sort_values('NUM PEAKS', ascending=False).drop_duplicates(['INCHIKEY', 'PRECURSORTYPE']).sort_index()
        # Re convert to MSP
        POS_GC = []
        for index, row in POS_GC_df.iterrows():
            SPECTRUM = ""
    ...
    if empty == False:
        ...
        NEG_LC_df = pd.DataFrame.from_dict(dictionary)
        # Removing duplicatas
        NEG_LC_df = NEG_LC_df.sort_values('NUM PEAKS', ascending=False).drop_duplicates(['INCHIKEY', 'PRECURSORTYPE']).sort_index()
        # Re convert to MSP
        NEG_LC = []
        for index, row in NEG_LC_df.iterrows():
            SPECTRUM = ""
    ...
    if empty == False:
        ...
        NEG_GC_df = pd.DataFrame.from_dict(dictionary)
        # Removing duplicatas
        NEG_GC_df = NEG_GC_df.sort_values('NUM PEAKS', ascending=False).drop_duplicates(['INCHIKEY', 'PRECURSORTYPE']).sort_index()
        # Re convert to MSP
        NEG_GC = []
        for index, row in NEG_GC_df.iterrows():
            SPECTRUM = ""
