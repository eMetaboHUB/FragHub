...
#             df_slice.to_csv(rf"C:\Users\Axel\PycharmProjects\msp_v3\OUTPUT\MSP\TEST\test_mona.csv", mode='w', sep=";", quotechar='"', encoding="UTF-8", index=False)
#         else:
#             # Append dans le fichier sans écrire les en-têtes pour les autres fractions
#             df_slice.to_csv(rf"C:\Users\Axel\PycharmProjects\msp_v3\OUTPUT\MSP\TEST\test_mona.csv", mode='a', header=False, index=False, sep=";", quotechar='"', encoding="UTF-8")
#
