...
## test script
dfcpd = pd.read_excel(r"D:\Axel\DATAS\ISTD_ALL\filtered_DB\Agromix_C18_1.5RT_Jul2023_pos_filtered.xlsx")
res = []
...
with open(r"D:\Axel\DATAS\ISTD_ALL\filtered_DB\ISTD_pos_smiles_NPclass_complete.json","w") as jsonFile:
