...
global keys_dict
Key_dataframe = pd.read_csv(os.path.abspath("../Generate_csv_from_original_files/datas/key_to_convert.csv"),sep=";", encoding="UTF-8") # Remplacez 'your_file.csv' par le chemin de votre fichier
