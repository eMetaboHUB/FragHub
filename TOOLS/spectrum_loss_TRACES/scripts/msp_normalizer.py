...
def peak_list_to_np_array(peak_list, precursormz, peaks_filters_not_valid):
    """
    ...
    peak_list, peaks_filters_not_valid = apply_filters(peak_list, precursormz, parameters_dict, peaks_filters_not_valid)

    # Return the sorted and preset-filtered numpy array of peaks.
    return peak_list, peaks_filters_not_valid
...
def spectrum_cleaning(spectrum):
    ...
    if not peak_list:
        no_peaks_list = 1
        return None, no_smiles_no_inchi, no_or_bad_precursormz_and_no_or_bad_addcut, no_peaks_list, peaks_filters_not_valid, old_spectrum
    ...
    if "PRECURSORMZ" in spectrum:
        if re.search(float_check_pattern, str(spectrum["PRECURSORMZ"])):
            ...
            peak_list_np, peaks_filters_not_valid = peak_list_to_np_array(peak_list, float_precursor_mz, peaks_filters_not_valid)
            ...
            return spectrum, no_smiles_no_inchi, no_or_bad_precursormz_and_no_or_bad_addcut, no_peaks_list, peaks_filters_not_valid, old_spectrum
        else:
            no_or_bad_precursormz_and_no_or_bad_addcut = 1
            return None, no_smiles_no_inchi, no_or_bad_precursormz_and_no_or_bad_addcut, no_peaks_list, peaks_filters_not_valid, old_spectrum
    return spectrum, no_smiles_no_inchi, no_or_bad_precursormz_and_no_or_bad_addcut, no_peaks_list, peaks_filters_not_valid, old_spectrum
