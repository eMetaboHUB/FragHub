...
2) Double-click on your corresponding OS run script into scripts folder.<br>
   ...
   4) Third tab: The 'Reset updates' option, when checked, allows for a reset of everything related to previously encountered spectra. This will also delete all existing files located in the OUTPUT folder.<br>![img_2.png](img_2.png)
