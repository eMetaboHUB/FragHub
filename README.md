...
2) CSV files need to be separated by ";" with quotechar '"' and peaks columns need to be named "peaks" and formatted like this '"[[79.054840, 12486.074219], [79.629868, 854.089905]]"'<br>
